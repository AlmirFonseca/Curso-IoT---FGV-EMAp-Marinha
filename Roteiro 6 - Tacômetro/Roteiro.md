...
Proposta de motor dc, controle com TIP122 e PWM, controle de velocidade com joystick e tacômetro com sensor de efeito hall.
Bloco 1: Motores DC
Bloco 2: Controlar a Velocidade do Motor com PWM
...
- 1x Placa Arduino (Uno, Mega, ou similar)
- 1x Cabo USB para conexão com o computador
- 1x Motor DC (corrente contínua)
- 1x Transistor de Potência TIP122
- 1x Joystick (potenciômetro)
- 1x Sensor de Efeito Hall
- 2x Ímã de Neodímio
- 1x Resistor de 300 ohms
- 1x Display LCD 16x2 com I2C
- Breadboard e jumpers
...
1. Insira o TIP122 no protoboard e conecte:
    - A Base (B) do TIP122 ao pino digital 11 do Arduino, passando através de um resistor de 300 ohms.
    - O Coletor (C) do TIP122 ao pino negativo (GND) do motor DC.
    - O Emissor (E) do TIP122 ao pino negativo (GND) do Arduino.

2. Conecte o pino positivo do motor DC ao pino positivo (VCC) do Arduino.
...
1. [Arduino Cookbook: Recipes to Begin, Expand, and Enhance Your Projects](https://www.amazon.com/Arduino-Cookbook-Michael-Margolis/dp/1449313876)
2. [Encyclopedia of Electronic Components Volume 1: Resistors, Capacitors, Inductors, Switches, Encoders, Relays, Transistors](https://www.amazon.com/Encyclopedia-Electronic-Components-Resistors-Transistors/dp/1449333893)
3. [Encyclopedia of Electronic Components Volume 2: LEDs, LCDs, Audio, Thyristors, Digital Logic, and Amplification](https://www.amazon.com/Encyclopedia-Electronic-Components-Thyristors-Amplification/dp/1449334180)
4. [Encyclopedia of Electronic Components Volume 3: Sensors, LEDs, Audio, Thyristors, Digital Logic, and Amplification](https://www.amazon.com/Encyclopedia-Electronic-Components-Sensors-Amplification/dp/1449334318)
